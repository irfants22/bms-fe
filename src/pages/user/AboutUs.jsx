      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                ...
                dan menjual berbagai produk makanan ringan sejak tahun 2016.
                Usaha ini menawarkan dua kategori utama produk, yaitu makanan
                ringan dan kue kering.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-orange-50 p-6 rounded-lg text-center">
            ...
            <p className="text-gray-600">Hari Pengiriman</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gray-600 text-lg leading-relaxed">
                Proses pengiriman produk memakan waktu sekitar 2-3 hari setelah
                produksi, dengan cakupan wilayah yang meliputi JABODETABEK dan
                berpotensi mencakup wilayah yang lebih luas.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              pilihan, menjaga tradisi cita rasa, dan memberikan pelayanan
